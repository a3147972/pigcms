...
document.writeln("	background-image: -webkit-gradient(linear, left top, left bottom, from( #750003 ), to( #750003 )); \/* Saf4+, Chrome *\/");
document.writeln("	background-image: -webkit-linear-gradient(#750003, #750003); \/* Chrome 10+, Saf5.1+ *\/");
document.writeln("	background-image:    -moz-linear-gradient(#750003, #750003); \/* FF3.6 *\/");
document.writeln("	background-image:     -ms-linear-gradient(#750003, #750003); \/* IE10 *\/");
document.writeln("	background-image:      -o-linear-gradient(#750003, #750003); \/* Opera 11.10+ *\/");
document.writeln("	background-image:         linear-gradient(#750003, #750003);");
document.writeln("	");
document.writeln("}");
...
document.writeln("	background: linear-gradient(#FBFBFB, #ffffff) repeat scroll 0 0 #FFF9DF;");
...
jQuery(document).ready(function () { 
	jQuery("#windowcenter").css("top",top);
	jQuery("#windowclosebutton").click(function () { 
	jQuery("#windowcenter").fadeOut(500);
}); 
...
popHeight=jQuery(".window").height(); 
popWidth=jQuery(".window").width(); 
var popY=(windowHeight-popHeight)/2; 
var popX=(windowWidth-popWidth)/2; 
jQuery("#windowcenter").css("top",popY).css("left",popX).slideToggle("slow"); 
jQuery("#windowcenter").css("top",popY+scrollHeight).fadeIn("slow"); 
*/
