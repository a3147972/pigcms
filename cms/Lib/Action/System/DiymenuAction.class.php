...
class DiymenuAction extends BaseAction
{
    ...
    public function class_add()
    {
        if (IS_POST) {
            ...
            $data["keyword"] = ($_POST["keyword"] ? htmlspecialchars($_POST["keyword"]) : "");
            $data["url"] = ($_POST["url"] ? htmlspecialchars_decode($_POST["url"]) : "");
            $data["wxsys"] = ($_POST["wxsys"] ? htmlspecialchars($_POST["wxsys"]) : "");
    ...
    public function class_edit()
    {
        ...
        if (IS_POST) {
            $set["pid"] = ($_POST["pid"] ? intval($_POST["pid"]) : 0);
            $set["keyword"] = ($_POST["keyword"] ? htmlspecialchars($_POST["keyword"]) : "");
            $set["url"] = ($_POST["url"] ? htmlspecialchars_decode($_POST["url"]) : "");
            $set["wxsys"] = ($_POST["wxsys"] ? htmlspecialchars($_POST["wxsys"]) : "");
            if (($_POST["menu_type"] == 1) && ($_POST["keyword"] != "")) {
                $set["url"] = $set["wxsys"] = "";
            }
            else {
