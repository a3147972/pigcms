...
class ArticleAction extends BaseAction
{
    ...
    public function one()
    {
        if (IS_POST) {
            ...
            $thisid = ($_POST["thisid"] ? intval($_POST["thisid"]) : 0);
            $data["content"] = ($_POST["content"] ? fulltext_filter($_POST["content"]) : "");
            $data["title"] = ($_POST["title"] ? htmlspecialchars($_POST["title"]) : "");
            $data["author"] = ($_POST["author"] ? htmlspecialchars($_POST["author"]) : "");
            $data["url"] = ($_POST["url"] ? $_POST["url"] : "");
            $data["url_title"] = ($_POST["url_title"] ? htmlspecialchars($_POST["url_title"]) : "");
            $data["cover_pic"] = ($_POST["cover_pic"] ? htmlspecialchars($_POST["cover_pic"]) : "");
            $data["digest"] = ($_POST["digest"] ? htmlspecialchars($_POST["digest"]) : "");
            $data["is_show"] = ($_POST["is_show"] ? intval($_POST["is_show"]) : 0);
            $data["classid"] = ($_POST["classid"] ? intval($_POST["classid"]) : 0);
            $data["classname"] = ($_POST["classname"] ? htmlspecialchars($_POST["classname"]) : "");
    ...
    {
        if (IS_POST) {
            $ids = ($_POST["imgids"] ? htmlspecialchars($_POST["imgids"]) : "");
            $ids = explode(",", $ids);
