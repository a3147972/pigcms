...
<body>
	...
	<div>
		<a class="my-account" href="<?php echo U('My/myinfo');?>">
			<img src="<?php echo ($static_path); ?>images/my-photo.png">
			...
			<div class="user-info more more-weak">
				<p class="uname"><?php echo ($now_user["nickname"]); ?><i class="level-icon level0"></i></p>
				<p class="umoney">余额：<strong><?php echo ($now_user["now_money"]); ?></strong> 元 &nbsp;&nbsp;&nbsp<span>积分：<strong><?php echo ($now_user["score_count"]); ?></strong> 分</span></p>
				<p>等级：<?php if(isset($levelarr[$now_user['level']])){ $imgstr=''; if(!empty($levelarr[$now_user['level']]['icon'])) $imgstr='<img src="'.$config['site_url'].$levelarr[$now_user['level']]['icon'].'" width="15" height="15">'; echo ' <strong>'.$levelarr[$now_user['level']]['lname'].'</strong>'; }else{echo '<strong>暂无等级</strong>';} ?></p>
			</div>
		</a>
	</div>
	<dl class="list">
		<dd>
			<a class="react" href="<?php echo U('My/group_order_list');?>">
				<div class="more more-weak">
					<i class="text-icon order-zuo order-icon">团</i><?php echo ($config["group_alias_name"]); ?>订单<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
			<a class="react" href="<?php echo U('My/meal_order_list');?>">
				<div class="more more-weak">
					<i class="text-icon order-jiudian order-icon" style="background-color:#0092DE;">订</i><?php echo ($config["meal_alias_name"]); ?>订单<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
			<a class="react" href="<?php echo U('My/lifeservice');?>">
				<div class="more more-weak">
	...
	<dl class="list">
		<dd>
			<a class="react" href="<?php echo U('My/group_collect');?>">
				<div class="more more-weak">
		...
		<dd>
			<a class="react" href="<?php echo U('My/follow_merchant');?>">
				<div class="more more-weak">
		...
		<dd>
			<a class="react" href="<?php echo U('My/join_lottery');?>">
				<div class="more more-weak">
	...
	<dl class="list">
		<dd>
			<a class="react" href="<?php echo U('My/card_list');?>">
				<div class="more more-weak">
		...
		<dd>
			<a class="react" href="<?php echo U('My/cards');?>">
				<div class="more more-weak">
	...
	<?php if(isset($config['wap_home_show_classify'])): ?><dl class="list">
			<dd>
				<a class="react" href="<?php echo U('Classify/myCenter');?>">
					<div class="more more-weak">
	...
	<dl class="list">
		<dd>
			<a class="react" href="<?php echo U('Login/logout');?>">
				<div class="more-weak" style="color:#FF658E;">
					<?php if($is_wexin_browser): ?>重新登录<?php else: ?>退出登录<?php endif; ?>
				</div>
			</a>
		</dd>
	</dl>
