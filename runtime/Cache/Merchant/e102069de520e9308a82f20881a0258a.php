...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><a href="<?php echo U('Customer/service');?>">客服列表</a></li>
		</ul>
	</div>
	<!-- 内容头部 -->
		...
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12" style="padding-left:0px;padding-right:0px;">
					<a class="btn btn-success" href="<?php echo U('Customer/add');?>">创建客服</a>
					<div class="grid-view" style="padding-top:5px;">
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if($services): if(is_array($services)): $i = 0; $__LIST__ = $services;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<?php if($i%2 == 0): ?>odd<?php else: ?>even<?php endif; ?>">
											<td><?php echo ($vo["pigcms_id"]); ?></td>
											<td><?php echo ($vo["nickname"]); ?></td>
											<td><img alt="<?php echo ($vo["nickname"]); ?>" src="<?php echo ($vo["head_img"]); ?>" height="80"></td>
											<td><?php echo (date('Y-m-d H:i:s',$vo["dateline"])); ?></td>
											<td align="center">
											
												<a title="修改" class="green" style="padding-right:8px;" href="<?php echo U('Customer/add',array('pigcms_id'=>$vo['pigcms_id']));?>">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												
												<a title="删除" class="red" style="padding-right:8px;" href="<?php echo U('Customer/del',array('pigcms_id' => $vo['pigcms_id']));?>">
													<i class="ace-icon fa fa-trash-o bigger-130"></i>
												</a>
											</td>
										</tr><?php endforeach; endif; else: echo "" ;endif; ?>
								<?php else: ?>
									<tr class="odd"><td class="button-column" colspan="5" >暂无客服！</td></tr><?php endif; ?>
							</tbody>
						</table>
					</div>
				</div>
