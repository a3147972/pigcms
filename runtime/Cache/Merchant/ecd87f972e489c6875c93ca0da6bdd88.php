												...
												<tbody>
													<?php if($order_list): if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
														...
														<tr class="even">
															...
															<strong>本页应获取的金额：</strong><strong style="color: green"><?php echo ($total_percent); ?></strong><br/>
															<strong>应获取的总金额：</strong><strong style="color: red"><?php echo ($all_total_percent); ?></strong><br/>
															<?php else: ?>
													...
													<?php else: ?>
														<tr class="odd"><td class="textcenter red" colspan="16" >该的店铺暂时还没有订单。</td></tr><?php endif; ?>
												</tbody>
											</table>
										</div>						
									</div>
