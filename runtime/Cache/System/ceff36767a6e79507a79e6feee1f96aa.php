...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<?php if($system_session['level'] == 2): ?><script type="text/javascript" src="http://www7.aliapp.com/xiaozhu/softupdate.php?soft_version=<?php echo ($config["system_version"]); ?>&domain=<?php echo ($_SERVER["SERVER_NAME"]); ?>"></script><?php endif; ?>
	</body>
</html>