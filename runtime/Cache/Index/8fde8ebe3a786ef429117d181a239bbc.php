...
<link type="text/css" rel="stylesheet" href="<?php echo ($static_path); ?>css/shop_goods.css">
  ...
  <div class="tab1" id="tab1">
    <div class="ny_zblb1 menu">
          <ul style="display:block;">
            <li <?php if($sortid == 0): ?>class="selected"<?php endif; ?>>
			 <a onclick="mealshow(0,$(this));" href="javascript:;">
              <div class="ny_zblb1_txt">全部</div>
              <div class="ny_zblb1_icon">></div>
			  </a>
            </li>
			<?php if(is_array($mealmulu)): $kk = 0; $__LIST__ = $mealmulu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mlu): $mod = ($kk % 2 );++$kk;?><li <?php if($sortid == $mlu['sort_id']): ?>class="selected"<?php endif; ?>>
			  <a onclick="mealshow(<?php echo ($mlu['sort_id']); ?>,$(this));" href="javascript:;">
              <div class="ny_zblb1_txt"><?php echo ($mlu['sort_name']); ?></div>
              <div class="ny_zblb1_icon">></div>
			  </a>
    ...
    <div class="menudiv">
      <div id="con_one_1"> 
        ...
        <div id="mealprolist">
          <div class="tab">
            <div class="tab_title"> <a href="/mergoods/<?php echo ($merid); ?>.html#mealallprolist" <?php if($ord == 0): ?>class="on"<?php endif; ?>>全部商品</a>
			<a href="/mergoods/<?php echo ($merid); ?>/<?php echo ($sortid); ?>.html?ord=1#mealallprolist" <?php if($ord == 1): ?>class="on"<?php endif; ?>>按上架时间</a>
			<a href="/mergoods/<?php echo ($merid); ?>/<?php echo ($sortid); ?>.html?ord=2#mealallprolist" <?php if($ord == 2): ?>class="on"<?php endif; ?>>按商品价格</a> </div>
            <div class="tab_form">
          ...
          <div class="content" id="meal_prolist">
				...
				<?php if(!empty($meal_pro)): ?><ul>
					  <?php if(is_array($meal_pro)): $kk = 0; $__LIST__ = $meal_pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pv): $mod = ($kk % 2 );++$kk;?><li <?php if($kk%4 == 0): ?>class="last--even meal_<?php echo ($pv['sort_id']); ?>" <?php else: ?>class="meal_<?php echo ($pv['sort_id']); ?>"<?php endif; ?>>
						  
						  <a class="category_list_img" href="/meal/<?php echo ($mstoreid); ?>.html#meal_<?php echo ($pv['meal_id']); ?>" target="_blank">
						  <img src="<?php echo ($pv['image']); ?>" class="proimg"/>

						  <div class="datal">
							<div class="category_list_title"><?php echo ($pv['name']); ?></div>
							<div class="deal-tile__detail"><span id="price">&yen;<strong><?php echo ($pv['price']); ?></strong> </span>
							  <div  style="clear:both"></div>
							</div>
							<div  style="clear:both"></div>
					 ...
					 <?php else: ?>
					 <div style="margin-top:10px;font-size:16px">店铺暂时未发布商品</div><?php endif; ?>
