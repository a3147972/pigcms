...
<script src="<?php echo ($static_path); ?>js/jquery.quicksand.js" type="text/javascript"></script>
<script src="<?php echo ($static_path); ?>js/jquery.easing.js" type="text/javascript"></script>
<script src="<?php echo ($static_path); ?>js/jquery.prettyPhoto.js" type="text/javascript"></script>
<script src="<?php echo ($static_path); ?>js/script.js" type="text/javascript"></script>
...
<link type="text/css" href="<?php echo ($static_path); ?>css/shop_photo.css" rel="stylesheet" >
...
<div class="wrapper">
  <div class="portfolio-content">
    <ul class="portfolio-categ filter">
      <li class="all <?php if(!($cyid > 0)): ?>active<?php endif; ?>"> 全部图片 </li>
	  <?php if(is_array($classify)): $kk = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cyv): $mod = ($kk % 2 );++$kk;?><li class="cat-item-<?php echo ($cyv['id']); ?> <?php if($cyid == $cyv['id']): ?>active<?php endif; ?>"><?php echo ($cyv['cyname']); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <div class="imgshowdiv">
    <ul class="portfolio-area">
	  <?php if(is_array($imgarr)): $i = 0; $__LIST__ = $imgarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$imgv): $mod = ($i % 2 );++$i;?><li class="portfolio-item2" data-id="id-<?php echo ($key); ?>" data-type="cat-item-<?php echo ($imgv[cyid]); ?>">
			<div> <span class="image-block"> <a class="image-zoom" href="<?php echo ($config["site_url"]); ?>/<?php echo ($imgv[imgstr]); ?>" rel="prettyPhoto[gallery]"><img width="190" height="190" src="<?php echo ($config["site_url"]); ?>/<?php echo ($imgv[imgstr]); ?>"> </a> </span> </div>
