...
if($method == 'show_license') {//声明
	...
	if($submit) {
		...
		if($confstatus['status']==1){
			...
			$db->query("INSERT INTO pigcms_admin (`id`, `account`, `pwd`,`last_ip`, `last_time`, `login_count`, `status`, `area_id`, `level`,`realname`, `email`, `qq`, `phone`, `key`) VALUES
(1, '".$username."', '".$password."', '1018520901', '1440209047', '22', 1, 0, 2,'微赢','76020694@qq.com','76020694','18968920219','efd8adeadf47ebd680e2a2be5bdc62ce')");
			//新增一个标识文件，用来屏蔽重新安装
