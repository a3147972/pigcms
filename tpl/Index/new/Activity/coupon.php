						...
						<div class="product_list_top">
							...
							<div class="product_info_top cf">
								...
								<else/>
									...
									<div class="product_info_list_num">{pigcms{$now_activity.mer_score}<span>分</span><if condition="$now_activity['all_count']-$now_activity['part_count'] gt 0"><span class="score_tips">您可以选择使用  <strong>{pigcms{$now_activity['mer_score']/$config['activity_score_scale']}</strong> 平台积分参与活动</span></if></div>
								</if>
							</div>
