      ...
      <div id="con_one_1">
        <section class="server dynamics">
          <div class="section_title">
            <div class="section_txt">{pigcms{$cyname}</div>
          ...
          <ul>
		   <if condition="!empty($introduce)">
            ...
            <li>
              <div class="shop_dynamics_left"><span><img src="{pigcms{$static_path}images/12322_03.png" /></span><a href="{pigcms{$config.site_url}/newsdetail/{pigcms{$merid}.html?newsid={pigcms{$nvv['id']}">{pigcms{$nvv['title']}</a></div>
              <div class="shop_dynamics_right">{pigcms{$nvv['addtime']|date="Y-m-d H:i:s",###}</div>
            </li>
			</volist>
			<else />
			 <li>暂无资讯</li>
