...
<head>
	...
	<script>var group_index_sort_url="{pigcms{:U('Index/group_index_sort')}";</script>
	<script src="{pigcms{$static_path}js/index.js"></script>
	<!-- 引导页--> 
		<link rel="stylesheet" href="{pigcms{$static_path}css/jquery.fullPage.css"/>
		<script src="{pigcms{$static_path}js/jquery.fullPage.min.js"></script>
		<script>
			$(function(){
				if(getCookie('index_guide') != '1'){
					$('.index_guide_div').addClass('blur');
					$('#dowebok').fullpage({
						sectionsColor: [' '],
						'navigation': true,
					});
		...
		<style>
			.section{text-align: center; font: 50px "Microsoft Yahei"; color: #fff; margin:0px; padding:0px; border:0px;  }
		</style>
		<script>
			$(function(){
				$('#btnclick2').click(function(){
					$('.blur').css('-webkit-filter',' blur(0px)').css('-moz-filter','blur(0px)').css('-o-filter','blur(0px)').css('-ms-filter','blur(0px)').css('filter','blur(0px)').css('filter','  progid:DXImageTransform.Microsoft.Blur(PixelRadius=0, MakeShadow=false)'); 
...
<body id="index" class="pg-floor over" style="overflow:hidden;height:100%">
	<!-- 模糊效果-->
	<div class="index_guide_div">
						...
						<div class="content__cell content__cell--slider">
							<div class="component-index-slider">
								<div class="index-slider ui-slider log-mod-viewed">
									...
									<div class="head ccf">
										<h2><span class="icon F-glob F-glob-star"></span>最新团购</h2>
								...
								<if condition="!empty($vo['group_list'])">
									<div class="category-floor">
										...
										<div class="category-floor__foot" data-mtnode="Acategory">
											<a href="{pigcms{$vo.url}" target="_blank" class="link"><span>更多{pigcms{$vo.cat_name}团购，请点击查看<i class="link__icon"></i></span></a>
										</div>
									</div>
								</if>
							</volist>
	...
	<!-- 引导页-->    
    <div id="postit" style="left:0;top:0">
        <div align="right" id="navbutt" >
            <b>
				<a href="javascript:closeit()" id="btnclick2" >
                    <img src="{pigcms{$static_public}images/index_guide/1-1.png"  />
                </a>
			</b>
		</div>
		<div id="dowebok" class="dowe"> 
			<div class="iediv">
				<div class="section" >
					<img src="{pigcms{$static_public}images/index_guide/1.png" alt=""/>
				</div>
				<div class="section">
					<img src="{pigcms{$static_public}images/index_guide/2.png" alt=""/>
				</div>
				<div class="section">
					<img src="{pigcms{$static_public}images/index_guide/3.png" alt=""/>
				</div>
				<div class="section">
					<img src="{pigcms{$static_public}images/index_guide/4.png" alt=""/>
				</div>
				<div class="section">
					<img src="{pigcms{$static_public}images/index_guide/5.png" alt=""/>
				</div>
			</div>
		</div>
    </div>
	<script>
		...
		function closeit(){
			...
			//document.cookie="index_guide=1;expires="+date.toGMTString(); 
			document.cookie="index_guide=1";
