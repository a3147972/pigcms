...
<head>
    ...
    <link rel="stylesheet" href="{pigcms{$static_path}weixin/weixin.css"/>
</head>
<body>
<div id="header">
        ...
        <div class="fixed">
            <div class="top-1">
                ...
                <div id="qrcode-wrapper">
                    <div class="qrcode" style="background-image:url({pigcms{$config.wechat_qrcode});background-size:100%;"></div>
                    <div id="btn">
...
<script src="{pigcms{$static_path}weixin/jquery.js"></script>
<script src="{pigcms{$static_path}weixin/rotate.js"></script>
<script src="{pigcms{$static_path}weixin/weixin.js"></script>
</body>
</html>
