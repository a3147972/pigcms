					   ...
					   <input  name="idx" type="hidden" value="{pigcms{$fbintroduce['id']}"/>
						<div class="tab-content">
							...
							<div class="form-group">
									...
									<label><input class="col-sm-2" value="1" name="isfabu" type="radio" <if condition="$fbintroduce['isfabu'] eq 1"> checked="checked" </if> />&nbsp;&nbsp;是</label>
									&nbsp;&nbsp;&nbsp;
									<label><input class="col-sm-2" value="0" name="isfabu" type="radio" <if condition="$fbintroduce['isfabu'] neq 1"> checked="checked" </if> />&nbsp;&nbsp;否</label>
