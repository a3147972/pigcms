						...
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="sort_name">终端号</label></label>
									<input class="col-sm-2" size="20" name="mp" id="mp" type="text" value="{pigcms{$orderprint['mp']}"/>
									<span class="form_tips">打印机底部查看</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="sort_name">用户ID</label></label>
									<input class="col-sm-2" size="20" name="username" id="username" type="text" value="{pigcms{$orderprint['username']}"/>
									<span class="form_tips">打印机后台,系统集成里面查看</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">API 密钥</label></label>
									<input class="col-sm-2" size="20" name="mcode" id="mcode" type="text" value="{pigcms{$orderprint['mcode']}"/>
									<span class="form_tips">打印机后台,系统集成里面查看</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">终端密钥</label></label>
