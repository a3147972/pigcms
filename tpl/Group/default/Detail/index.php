		...
		<div class="bdw" id="bdw">
			<div class="cf" id="bd">
				<div class="bread-nav">
					...
					<span>»</span>
					<a class="link--black__green" href="{pigcms{$f_category.url}">{pigcms{$f_category.cat_name}{pigcms{$config.group_alias_name}</a>
					<span>»</span>
						...
						<div class="deal-component-info J-deal-component-info J-hub">
							...
							<else/>
								<div class="deal-component-availability">
									...
									<a class="deal-component-availability-link" href="{pigcms{$s_category.url}">查看相关{pigcms{$config.group_alias_name}</a>
								</div>
							</if>
					...
					<if condition="$merchant_group_list">
						<div class="J-hub">
							<div id="deal-other-biz">
								<h3 class="biz-title">该商家的其他{pigcms{$config.group_alias_name}
									<div class="biz-subtitle">
										<span class="biz-header-title biz-header-title--right">已售</span><span class="biz-header-title biz-header-title--middle">门店价</span><span class="biz-header-title biz-header-title--left">{pigcms{$config.group_alias_name}价</span>
									</div>
								</h3>
								<ul class="item-list">
					...
					<if condition="$category_hot_group_list">
						<div class="J-bottom-list-wrapper deal-bottom-recommend" style="visibility:visible;">
							<div class="recommend-deals  recommend-skin" id="deal-bottom-list">
								<h3>你可能感兴趣的热门{pigcms{$config.group_alias_name}</h3>
					...
					<if condition="$like_group_list">
						<div class="component-top-deals">
							<div class="side-extension mall--small top-reco-deals cf log-mod-viewed">
	        					<h3>看了本{pigcms{$config.group_alias_name}的人还看了</h3>
