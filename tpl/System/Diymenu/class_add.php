	...
	<form id="myform" method="post" action="{pigcms{:U('Diymenu/class_add')}" enctype="multipart/form-data" frame="true" refresh="true">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<td><input type="text" class="input fl" name="keyword" style="width:200px;" placeholder="关联关键词" validate="maxlength:200,required:true"/></td>
			</tr>
			<tr style="display:none;" class="url">
				<th width="80">外链接url</th>
				<td>
				<input type="text" class="input fl" name="url" id="url" style="width:200px;" placeholder="外链接url" validate="maxlength:200,url:true"/>
