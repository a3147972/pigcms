...
<body id="index" data-com="pagecommon">
        ...
        <div class="content clr">
        	...
        	<div class="listPart clr">
                ...
                <p class="threes clr">
                	<a href="{pigcms{:U('Invitation/info', array('pigcms_id' => $vo['pigcms_id']))}">{pigcms{$vo['look_num']}条看过&nbsp;&nbsp;&nbsp;&nbsp;{pigcms{$vo['sign_num']}条报名</a><if condition="$vo['status']"><span style="float: right;margin-right:20px">已结束</span></if>
                </p>
                <!---->
            </div>
            </volist>
