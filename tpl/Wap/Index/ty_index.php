...
<meta charset="utf-8">
<link href="{pigcms{$static_path}css/ty/news5.css" rel="stylesheet" type="text/css" />
...
<div id="nav">
<div id="prev" onclick="myScroll.scrollToPage('prev', 0,400,{pigcms{$num-1});return false">&larr; prev</div>
<ul id="indicator">
<volist name="flash" id="so">
