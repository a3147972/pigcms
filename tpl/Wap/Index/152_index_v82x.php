...
<meta charset="utf-8">
<link href="{pigcms{$static_path}tpl/152/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul class="mainmenu">
	<volist name="info" id="vo">
		<li><a href="<if condition="$vo['url'] eq ''">{pigcms{:U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']))}<else/>{pigcms{$vo.url|htmlspecialchars_decode}</if>" ><b><img src="{pigcms{$vo.img}" /></b><span>{pigcms{$vo.name}</span></a></li>	
	</volist>	 
</ul>  
