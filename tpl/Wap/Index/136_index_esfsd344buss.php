...
<html>    <head>
       <if condition="$zd['status'] eq 1">
        ...
        <title>{pigcms{$tpl.wxname}|{pigcms{$busines['mtitle']}</title>
        <base href="." />
...
<link href="{pigcms{$static_path}css/allcss/cate36_4.css" rel="stylesheet" type="text/css" />
<style>
...
<div class="device" style="margin-bottom: 40px;">
