...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <if condition="$zd['status'] eq 1">
        ...
        <link href="{pigcms{$static_path}css/allcss/cate8_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
        <link href="{pigcms{$static_path}css/108/iscroll.css" rel="stylesheet" type="text/css" />
        <style>
            #cate9 {
        ...
        <script src="{pigcms{$static_path}css/108/iscroll.js" type="text/javascript"></script>
