...
<meta charset="utf-8">
<link href="{pigcms{$static_path}tpl/1114/css/cate.css" rel="stylesheet" type="text/css" />
        ...
        <div id="nav_uls" style="width:33.3%;">
          <ol>
					<volist name="info" id="vo" offset="4">
						...
						<li>
							<a href="javascript:swiper_2.slide({pigcms{$i-1});" <if condition="$i == 1">class="on"</if>>
