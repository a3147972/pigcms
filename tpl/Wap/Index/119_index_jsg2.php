...
<link href="{pigcms{$static_path}css/allcss/cate19_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
        
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/119/reset.css" media="all">
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/119/font-awesome.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/119/home-46.css" media="all"> -->
<script type="text/javascript" src="{pigcms{$static_path}css/116/jQuery.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/119/zepto.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/119/swipe.js"></script>
    </head>
            ...
            <ul class="list_ul">
				<volist name="info" id="vo">
					<if condition="$i%2 == 1"><li class="box"></if>
							...
							<dd>
								<span>
									<img src="{pigcms{$vo.img}" class="icon-smile" style="width:60px;height:40px;margin-top:5px;">
								</span>
							</dd>
							<dt style="font-size:11px;">{pigcms{$vo.name}</dt>
								</a>
							</dl>
