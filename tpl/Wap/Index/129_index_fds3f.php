...
<link href="{pigcms{$static_path}css/allcss/cate29_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
 
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/129/reset.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/129/home-20.css" media="all"> -->
<script type="text/javascript" src="{pigcms{$static_path}css/129/maivl.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/116/jQuery.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/129/swipe.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/129/zepto.js"></script>
...
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/129/font-awesome.css" media="all">
