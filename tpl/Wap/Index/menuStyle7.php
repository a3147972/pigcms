...
.plug-menu { -webkit-appearance:button; display:inline-block; width:36px; height:36px; border-radius:36px; position: absolute; bottom:17px; left: 17px; z-index:999; box-shadow: 0 0 0 4px #FFFFFF, 0 2px 5px 4px rgba(0, 0, 0, 0.25); background-color: #B70000; -webkit-transition: -webkit-transform 200ms; -webkit-transform:rotate(1deg); color:#fff; background-image:url('tpl/Wap/static/images/plug.png'); background-repeat: no-repeat; -webkit-background-size: 80% auto; background-size: 80% auto; background-position: center center; }
...
.top_menu>li a label { border-radius:32px; padding:5px 8px; background:{pigcms{$homeInfo.plugmenucolor}; }
...
<nav>
    <ul id="top_menu" class="top_menu">
      ...
      <volist name="catemenu" id="vo">
          <li class="out"> <a href="{pigcms{$vo.url}"><img src="{pigcms{$vo.picurl}"><label class="themeStyle">{pigcms{$vo.name}</label></a></li>
         </volist> 
</ul>
  </nav>
</div>
