...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <if condition="$zd['status'] eq 1">
        ...
        <link href="{pigcms{$static_path}css/allcss/cate7_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
        <link href="{pigcms{$static_path}css/107/iscroll.css" rel="stylesheet" type="text/css" />
        <style>
