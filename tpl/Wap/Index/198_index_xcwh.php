...
<meta charset="utf-8">
<link href="{pigcms{$static_path}tpl/198/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul  class="mainmenu">
	...
	<volist name="info" id="vo">
		<li><a href="<if condition="$vo['url'] eq ''">{pigcms{:U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']))}<else/>{pigcms{$vo.url|htmlspecialchars_decode}</if>" ><p><img src="{pigcms{$vo.img}" /><i></i><b>{pigcms{$vo.name}</b></p></a></li>
	</volist>
<div class="line"></div>
</ul>
