...
<link href="{pigcms{$static_path}tpl/1100/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul id="thelist">
    ...
    <volist name="flashbg" id="so">
        <li><p></p><img src="{pigcms{$so.img}" style="width:100%;height:100%" /></li>
    </volist>
...
<div class="device">
    ...
    <volist name="info" id="vo">
		...
		<if condition="$i%6 == 0 || $i == count($info) ">
            </div>
    	</div>
		</if>
	</volist>	
