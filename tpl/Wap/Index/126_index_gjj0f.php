...
<link href="{pigcms{$static_path}css/allcss/cate26_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
 
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/126/reset.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/126/home-28.css" media="all"> -->
<script type="text/javascript" src="{pigcms{$static_path}css/126/maivl.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/116/jQuery.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/126/swipe.js"></script>
<script type="text/javascript" src="{pigcms{$static_path}css/126/zepto.js"></script>
    </head>
...
<link rel="stylesheet" type="text/css" href="{pigcms{$static_path}css/126/font-awesome.css" media="all">
            ...
            <volist name="info" id="vo">
                <li>
                        <a href="<if condition="$vo['url'] eq ''">{pigcms{:U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']))}<else/>{pigcms{$vo.url|htmlspecialchars_decode}</if>">
                                ...
                                <figcaption style="height:33px; overflow:hidden;">{pigcms{$vo.name}</figcaption>
                            </figure>
                        </a>
                    </li>
                     </volist>
