...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <if condition="$zd['status'] eq 1">
        ...
        <link href="{pigcms{$static_path}css/allcss/cate3_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
        <link href="{pigcms{$static_path}css/103/iscroll.css" rel="stylesheet" type="text/css" />
        <style>


        </style>
        <script src="{pigcms{$static_path}css/103/iscroll.js" type="text/javascript"></script>
