...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <if condition="$zd['status'] eq 1">
        ...
        <link href="{pigcms{$static_path}css/allcss/cate11_{pigcms{$tpl.color_id}.css" rel="stylesheet" type="text/css" />
        <link href="{pigcms{$static_path}css/111/iscroll.css" rel="stylesheet" type="text/css"/>
		
        <style>


        </style>
        <script src="{pigcms{$static_path}css/111/iscroll.js" type="text/javascript"></script>
...
<div class="menubtn">
<div class="menumesg">
<div class="menutitle" style="width: 90px;overflow: hidden;height: 40px;">{pigcms{$vo.name}</div>
<div class="menuico"></div>
</div>
<div class="menuimg"><img src="{pigcms{$vo.img}" /><div class="menutext"></div></div>
</div>
</a>
</li>
            </volist>
