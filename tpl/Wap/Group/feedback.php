						...
						<volist name="list" id="vo">
							<dd class="dd-padding">
								<div class="feedbackCard">
									...
									<div class="score">
										<span class="stars"><for start="0" end="5"><if condition="$vo['score'] gt $i"><i class="text-icon icon-star"></i><else/><i class="text-icon icon-star-gray"></i></if></for><em class="star-text">{pigcms{$vo.score}</em></span>
