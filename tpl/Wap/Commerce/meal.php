...
<body>
    <div class="m_nav"> 
    <span> <a href="/wap.php?g=Wap&c=Commerce&a=index">商家中心</a> &gt; <a href="javascript:;" style="color:#FAFDCC;">{pigcms{$config.meal_alias_name}管理</a></span> 
   </div> 
	    <div style="margin-top:.2rem;">
		    <dl class="list" id="orders">
			<if condition="!empty($store_list)">
				<volist name="store_list" id="vo">
					<dd class="dealcard dd-padding">
							<ul class="dealcard-block-right">
								<li class="detail"><span class="dth">店铺名称：</span><span class="ttd">{pigcms{$vo.name}</span></li>
								<li class="detail"><span class="dth">联系电话：</span><span class="ttd">{pigcms{$vo.phone}</span></li>
								<li class="detail"><span class="dth">店铺地址：</span><span class="ttd">{pigcms{$vo.area_name}-{pigcms{$vo.adress}</span></li>
								<li class="name"><span class="dth">店铺二维码：</span>
								<span class="ttd"><a href="javascript:;" onclick="See_ErWM({pigcms{$vo.store_id});">查看二维码</a></span></li>
							</ul>
					</dd>
