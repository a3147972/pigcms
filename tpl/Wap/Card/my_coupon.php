...
<span class="title">
{pigcms{$item.title}(<if condition="$type eq 3">{pigcms{$item.integral}积分兑换<else/>可领取{pigcms{$item.count}张</if>)
...
<li>领取礼品卷要消耗<span class="max_count">{pigcms{$item.integral}</span>点积分。</li>
<else/>
